...
const ResetPassword = () => {
    ...
    useEffect(() => {
      if (resetSuccess) {
          setLocalREError({ message: "Your password has been successfully changed!", id: "success" });
      }
    ...
    return (
        <div className='resetMain'>
          <div className="lContainerRE">
            ...
            <label className="tolabel" htmlFor="password2">Repeat password:</label>
            <div style={{ position: 'relative', display: 'inline-block' }}>
              <input
            ...
            {localREError ? (
              <div className='toerror' id={localREError.id}>
